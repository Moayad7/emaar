...
services.innerHTML = `
  ${services_List.map((item) => `
             <a href="servicesItem.html" class="swiper-slide bg-cover bg-center" data-aos="fade-up"
        data-aos-duration="1000" style="background-image: url('assets/images/services/${item}.jpg');">
